...
The autouse `_isolate_apte_history` fixture in `tests/conftest.py`
...
into `.apte/history.jsonl` in the real project cwd.
"""
...
class TestDefaultHistoryDirOverride:
    ...
    def test_storage_default_points_to_tmp(self, tmp_path: Path) -> None:
        assert tmp_path / ".apte" == storage.DEFAULT_HISTORY_DIR
    ...
    def test_plugin_default_dir_follows_override(self, tmp_path: Path) -> None:
        ...
        assert plugin._history_dir == tmp_path / ".apte"
