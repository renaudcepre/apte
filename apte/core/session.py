...
if TYPE_CHECKING:
    ...
    from apte.compat import Self
    from apte.core.suite import ApteSuite
    from apte.entities import FixtureCallable
...
from apte.execution.capture import set_session_teardown_capture
...
from apte.history.plugin import HistoryPlugin
...
class ApteSession:
    ...
    def register_default_plugins(self) -> None:
        """Register all standard Apte plugins for CLI discovery."""
    ...
    def _register_suite_fixtures(self, suites: list[ApteSuite]) -> None:
