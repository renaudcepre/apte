...
from apte.core.execution import ParallelExecutor, SuiteManager, TestExecutor
from apte.core.outcome import OutcomeBuilder
from apte.core.session import ApteSession  # noqa: TC001 - used at runtime
from apte.core.tracker import SuiteTracker
...
from apte.evals.types import EvalCaseResult, EvalSuiteReport
...
from apte.execution.context import cancellation_event
from apte.execution.interrupt import InterruptHandler
...
class TestRunner:
    ...
    def __init__(self, session: ApteSession) -> None:
