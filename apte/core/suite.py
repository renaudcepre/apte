...
from apte.di.decorators import unwrap_fixture
...
from apte.di.decorators import get_fixture_marker
...
from apte.exceptions import ConcurrencyMismatchError, InvalidMaxConcurrencyError
...
class ApteSuite:
    ...
    def __init__(  # noqa: PLR0913
        ...
        self._session: ApteSession | None = None
        self._parent_suite: ApteSuite | None = None
        self._tests: list[TestRegistration] = []
        self._suites: list[ApteSuite] = []
    ...
    @property
    def suites(self) -> list[ApteSuite]:
        return self._suites
    ...
    def add_suite(self, suite: ApteSuite) -> None:
    ...
    def _attach_to_session(self, session: ApteSession) -> None:
