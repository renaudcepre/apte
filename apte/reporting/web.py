...
from apte.execution.capture import add_log_callback, remove_log_callback
...
try:
    ...
    raise ImportError(
        "WebReporter requires 'websockets' package. Install with: pip install apte[web]"
    ) from err
