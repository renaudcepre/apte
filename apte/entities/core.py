...
if TYPE_CHECKING:
    ...
    from apte.entities.events import TestCounts, TestResult
    from apte.entities.retry import Retry
    from apte.entities.skip import Skip
    from apte.entities.xfail import Xfail
    from apte.events.types import Event

from apte.entities.suite_path import SuitePath
...
class FixtureMarker:
    """Marker attached to decorated fixture functions (_apte_fixture attribute).
