...
from apte.evals.hashing import _canonical
from apte.evals.types import EvalScore

if TYPE_CHECKING:
    from collections.abc import Callable

    from apte.evals.types import Judge
    ...
    for item in items:
        ...
        if callable(item):
            raise TypeError(
                ...
                "Wrap it with @evaluator (from apte.evals) so it carries "
...
def evaluator(fn: Callable[..., Any]) -> Evaluator:
    """Turn a function into a Apte evaluator.
